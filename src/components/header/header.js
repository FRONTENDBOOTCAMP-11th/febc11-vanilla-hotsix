...
class HeaderComponent extends HTMLElement {
  ...
  // 헤더 렌더링 함수
  renderHeader() {
    const isMainPage = this.currentURL.includes('ainPage', 'mainpage');
    const isAuthorPage = this.currentURL.includes('uthorPage', 'authorpage');
    const isLoginPage = this.currentURL.includes('oginPage', 'loginpage');
    const isSignupPage = this.currentURL.includes('ignupPage', 'signuppage');
