...
const DUMMY_POST = {
  list: [
    ...
    content: "with 노슈니, 슈크림 마을, 마포청년나루 | 취업 준비를 위해 반드시 필요한 것 세 가지. 자기소개서, 이력서, 포트폴리오. 그중에서 최고로 중요한 것은 나! 그중에서 최고로 중요한 것은 나! 그중에서 최고로 중요한 것은 나!",
    commentCount: 0,
...
postList.innerHTML = DUMMY_POST.list.map(post =>{ 
